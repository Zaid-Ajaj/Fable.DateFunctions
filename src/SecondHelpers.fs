...
[<AutoOpen>]
module SecondHelpersDateTimeOffset =
    type DateTimeOffset with
        /// Add the specified number of seconds to the given date and returns a new date.
        member inline date.AddSeconds(amount: int) : DateTimeOffset = DateTimeOffset(ExternalDateFns.addSeconds date amount)
        /// Returns the number of seconds between the given dates.
        member inline date.DifferenceInSeconds(other: DateTimeOffset) : int = ExternalDateFns.differenceInSeconds date other
        /// Returns the end of a second for the given date. The result will be in the local timezone.
        member inline date.EndOfSecond() : DateTimeOffset = DateTimeOffset(ExternalDateFns.endOfSecond date)
        /// Returns the seconds of the given date.
        member inline date.GetSeconds() : int = ExternalDateFns.getSeconds date
        /// Returns whether the given dates are in the same second.
        member inline date.IsInTheSameSecondAs(other: DateTimeOffset) : bool = ExternalDateFns.isSameSecond date other
        /// Returns whether the given date is in the same second as the current date
        member inline date.IsInThisSecond() : bool = ExternalDateFns.isThisSecond date
        /// Sets the seconds to the given date.
        member inline date.SetSeconds(amount: int) : DateTimeOffset = DateTimeOffset(ExternalDateFns.setSeconds date amount)
        /// Returns the start of a second for the given date. The result will be in the local timezone.
        member inline date.StartOfSecond() : DateTimeOffset = DateTimeOffset(ExternalDateFns.startOfSecond date)
        /// Subtracts the specified number of seconds from the given date and return a new DateTime.
        member inline date.SubtractSeconds(amount : int) : DateTimeOffset = DateTimeOffset(ExternalDateFns.subSeconds date amount)